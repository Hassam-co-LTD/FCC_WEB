...
export class CreateDynamicFieldOptions implements OnInit {
  ...
  onSave(): void {
    ...
    this.api.saveTnx(payload, 'dynamic-dropdown').subscribe({
      next: (res) => {
        ...
        Swal.fire(
          'Saved!',
          'Dropdown option saved successfully',
          'success',
        ).then(() =>
          this.router.navigate(['/admin/dynamic-dropdown-option-inquiry'], {
  ...
  submit() {
    ...
    this.api
      .setTnxByStatus(payload, this.storeDropDown.id, 'dynamic-dropdown')
      .subscribe({
        next: (res) => {
  ...
  reject(id: number): void {
    ...
    Swal.fire({
      ...
      this.api.setTnxByStatus(payload, id, 'create-dropdown').subscribe({
        next: (res: any) => {
    ...
    this.api
      ...
      .subscribe({
        next: () => {
          Swal.fire(
            'Approved!',
            'Dropdown option approved successfully',
            'success',
          ).then(() =>
            this.router.navigate(['/admin/dynamic-dropdown-option-inquiry'], {

...
export class Preview implements OnInit {
  ...
  submit(): void {
    if (!this.hasPermission('EC_CreateSubmit')) {
      this.snackBar.open(
        'You do not have permission to submit an Export Collection.',
        'Close',
        { duration: 3000 },
      );
      return;
  ...
  approveTransaction(): void {
    if (!this.hasPermission('EC_InquiryApprove')) {
      this.snackBar.open(
        'You do not have permission to approve an Export Collection.',
        'Close',
        { duration: 3000 },
      );
      return;
  ...
  rejectTransaction(): void {
    if (!this.hasPermission('EC_InquiryReject')) {
      this.snackBar.open(
        'You do not have permission to reject an Export Collection.',
        'Close',
        { duration: 3000 },
      );
      return;

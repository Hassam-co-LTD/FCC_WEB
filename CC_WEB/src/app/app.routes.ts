                ...
                children: [
                    ...
                    // ==============================
                    {
                        ...
                        children: [
                            ...
                            { path: 'import-screen/success', loadComponent: () => import('./shared/success/success').then(m => m.Success) },
                    ...
                    // ==============================
                    {
                        ...
                        children: [
                            ...
                            { path: 'transfer/:tnxId', loadComponent: () => import('./screens/USER/Payment-Services/FundTransfer/internal-transfer/components/my-accounts/my-accounts').then(m => m.MyAccountsComponent) },
                            { path: 'general-details', loadComponent: () => import('./screens/USER/Payment-Services/FundTransfer/internal-transfer/components/my-accounts/components/general-details/general-details').then(m => m.GeneralDetails) }
                        ]
                    },
                    {
                        path: 'IBFT',
                        children: [
                            ...
                            { path: 'transfer/:tnxId', loadComponent: () => import('./screens/USER/Payment-Services/FundTransfer/internal-transfer/components/IBFT/IBFT').then(m => m.IBFT) },
                            { path: 'general-details', loadComponent: () => import('./screens/USER/Payment-Services/FundTransfer/internal-transfer/components/IBFT/general-details/general-details').then(m => m.GeneralDetails) }
                        ]
                    },
                    {
                    ...
                    { path: 'fund-transfer/with-in', loadComponent: () => import('./screens/USER/Payment-Services/FundTransfer/third-party-transfer/third-party-transfer').then((m) => m.ThirdPartyTransfer) },
                    { path: 'fund-transfer/ibft', loadComponent: () => import('./screens/USER/Payment-Services/FundTransfer/third-party-transfer/third-party-transfer').then((m) => m.ThirdPartyTransfer) },
                    { path: 'fund-transfer/fund-transfer-records', loadComponent: () => import('./screens/USER/Payment-Services/FundTransfer/sub-menus/records/inquiry-of-fundtransfer-records/inquiry-of-fundtransfer-records').then((m) => m.InquiryOfFundtransferRecords) },
                ]
            },

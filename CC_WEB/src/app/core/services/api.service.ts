...
import {
  ...
  AccountsMaster,
  AccountAccessPolicyDTO,
} from '../models/my-accounts';
import {
  RecordListDTO,
  UndertakingRequestDTO,
  UndertakingResponseDTO,
  UndertakingFormModel,
} from '../models/undertaking-lc';
...
export class ApiService {
  ...
  getAmendmentByTnxId(tnxId: string): Observable<ImportLcTransaction> {
    const companyId =
      JSON.parse(sessionStorage.getItem('userData') || '{}')?.companyId ?? '';
    const headers = new HttpHeaders({ companyid: companyId });

    // fetches the pending(I) AMD event for this tnxId
    return this.http
      .get<ImportLcTransaction>(`${this.baseeventUrl}/amend/${tnxId}`, {
        headers,
      })
      .pipe(catchError(this.handleError));
  }
  ...
  getApprovedMasterLcRecords(): Observable<ImportLcTransaction[]> {
    ...
    return this.http
      .get<
        ImportLcTransaction[]
      >(`${this.baseeventUrl}/amend/live-master-records`, { headers })
      .pipe(catchError(this.handleError));
  }
  ...
  getAmendRecordTransactionsByStatus(
    ...
    return this.http
      .get<
        ImportLcTransaction[]
      >(`${this.baseeventUrl}/amend/records/${eventLcStatus}`, { headers })
      .pipe(catchError(this.handleError));
  }
  ...
  getAmendmentByEventRefNo(
    ...
    const headers = new HttpHeaders({ companyid: companyId });
    return this.http
      .get<ImportLcTransaction>(`${this.baseeventUrl}/event/${eventRefNo}`, {
        headers,
      })
      .pipe(catchError(this.handleError));
  }
  ...
  getRecordTransactionsByStatus(
    ...
    return this.http
      .get<
        ImportLcTransaction[]
      >(`${this.baseUrl}/importlc/records/${status}`, { headers })
      .pipe(catchError(this.handleError));
  }
  ...
  savePendingShippingGuarantee(
    ...
    return this.http
      .post<ShippingGuaranteeTransaction>(
  ...
  getRecordTransactionsByStatusForShippingGuarantee(
    status: String,
  ): Observable<ShippingGuaranteeTransaction[]> {
    const companyId = sessionStorage.getItem('companyId');
    const headers = new HttpHeaders({
    ...
    return this.http
      ...
      >(`${this.baseUrl}/shippingguarantee/records/${status}`, { headers })
      .pipe(catchError(this.handleError));
  }
  ...
  getTransactionForShippingGuaranteeByTnxId(
    tnxId: string,
  ): Observable<ShippingGuaranteeTransaction> {
    return this.http
  ...
  /** Approve transaction */
  approveTransactionForShippingGuarantee(
    tnxId: string,
    data: ShippingGuaranteeTransaction,
  ): Observable<ShippingGuaranteeTransaction> {
    console.log('Approving transaction ID:', tnxId);
  ...
  /** Reject Reason */
  rejectTransactionForShippingGuarantee(
    tnxId: string,
    reason: string,
  ): Observable<ShippingGuaranteeTransaction> {
    return this.http
  ...
  // update-Rejected
  updateRejectedTransactionForShippingGuarantee(
    tnxId: string,
    payload: ShippingGuaranteeTransaction,
  ) {
    return this.http
  ...
  // Save LC Record (pending record) - status "I"
  savePendingForExportCollection(
    ...
    return this.http
      .post<ExportCollectionTransaction>(
  ...
  // Get lightweight records by status (DTO) {-------FOR TABS VIEW-------} --- List so using ShippingGuaranteeTransaction[] -> "[]"
  getRecordTransactionsByStatusForExportCollection(
    status: String,
  ): Observable<ExportCollectionTransaction[]> {
    const companyId = sessionStorage.getItem('companyId');
    const headers = new HttpHeaders({
    ...
    return this.http
      ...
      >(`${this.baseUrl}/exportcollection/records/${status}`, { headers })
      .pipe(catchError(this.handleError));
  }
  ...
  // Get Transaction by TNX ID for record clicking for READ-ONLY view for approved/rejected records --- NOT a List so not using ShippingGuaranteeTransaction X -> []
  getTransactionForExportCollectionByTnxId(
    tnxId: string,
  ): Observable<ExportCollectionTransaction> {
    return this.http
  ...
  /** Approve transaction */
  approveTransactionForExportCollection(
    tnxId: string,
    data: ExportCollectionTransaction,
  ): Observable<ExportCollectionTransaction> {
    console.log('Approving transaction ID:', tnxId);
  ...
  /** Reject Reason */
  rejectTransactionForExportCollection(
    tnxId: string,
    reason: string,
  ): Observable<ExportCollectionTransaction> {
    return this.http
  ...
  // update-Rejected
  updateRejectedTransactionForExportCollection(
    tnxId: string,
    payload: ExportCollectionTransaction,
  ) {
    return this.http
  ...
  getUndertakingByStatus(status: string): Observable<RecordListDTO[]> {
    ...
    return this.http
      .get<
        RecordListDTO[]
      >(`${this.baseUrl}/undertaking_lc/status/${status}`, { headers })
      .pipe(catchError(this.handleError));
  }

  getUndertakingRecordsByStatus(status: string): Observable<RecordListDTO[]> {
    return this.http
      .get<RecordListDTO[]>(`${this.baseUrl}/undertaking_lc/records/${status}`)
      .pipe(catchError(this.handleError));
  }

  getUndertakingByTnxId(tnxId: string): Observable<UndertakingResponseDTO> {
    return this.http
      .get<UndertakingResponseDTO>(`${this.baseUrl}/undertaking_lc/${tnxId}`)
      .pipe(catchError(this.handleError));
  }

  saveUndertakingDraft(
  ...
  updateUndertakingDraft(
    ...
    return this.http
      .put<UndertakingResponseDTO>(url, dto, { headers })
      .pipe(catchError(this.handleError));
  }
  ...
  getTransferRecordsByStatus(
    ...
    return this.http
      .get<
        RecordsListTransferDTO[]
      >(`${this.baseUrl}/transfers/records/${status}`)
      .pipe(catchError(this.handleError));
  }
  ...
  updateTransferDraft(
    ...
    return this.http
      .put<TransferDTO>(`${this.baseUrl}/transfers/${tnxId}`, data)
      .pipe(catchError(this.handleError));
  }

  submitTransfer(tnxId: string, data: TransferDTO): Observable<TransferDTO> {
    return this.http
      .post<TransferDTO>(`${this.baseUrl}/transfers/submit/${tnxId}`, data)
      .pipe(catchError(this.handleError));
  }

  approveTransfer(tnxId: string, data: TransferDTO): Observable<TransferDTO> {
    return this.http
      .post<TransferDTO>(`${this.baseUrl}/transfers/approve/${tnxId}`, data)
      .pipe(catchError(this.handleError));
  }
  ...
  updateRejectedTransfer(
    ...
    return this.http
      .put<TransferDTO>(
        `${this.baseUrl}/transfers/updateRejected/${tnxId}`,
        data,
      )
      .pipe(catchError(this.handleError));
  }
  ...
  getAccessibleAccounts(
    ...
    return this.http
      .get<
        AccountsMaster[]
      >(`${this.baseUrl}accounts/accessible?companyId=${companyId}&userId=${userId}&userRole=${userRole}`, { headers })
      .pipe(catchError(this.handleError));
  }
  ...
  getTransferFromAccounts(
    ...
    return this.http
      .get<
        AccountsMaster[]
      >(`${this.baseUrl}accounts/transfer-from?companyId=${companyId}&userId=${userId}&userRole=${userRole}`, { headers })
      .pipe(catchError(this.handleError));
  }
  ...
  getTransferToAccounts(
    ...
    return this.http
      .get<
        AccountsMaster[]
      >(`${this.baseUrl}accounts/transfer-to?companyId=${companyId}&userId=${userId}&userRole=${userRole}`, { headers })
      .pipe(catchError(this.handleError));
  }
  ...
  getCompanyAccounts(companyId: string): Observable<AccountsMaster[]> {
    ...
    return this.http
      .get<
        AccountsMaster[]
      >(`${this.baseUrl}accounts/company/${companyId}`, { headers })
      .pipe(catchError(this.handleError));
  }
  ...
  getAccountByNumber(accountNumber: string): Observable<AccountsMaster> {
    return this.http
      .get<AccountsMaster>(`${this.baseUrl}accounts/${accountNumber}`)
      .pipe(catchError(this.handleError));
  }
  ...
  getUserRoles(): Observable<any[]> {
    return this.http
      .get<any[]>(`${this.baseUrl}roles/active`)
      .pipe(catchError(this.handleError));
  }
  ...
  getRoleByCode(roleCode: string): Observable<any> {
    return this.http
      .get<any>(`${this.baseUrl}roles/code/${roleCode}`)
      .pipe(catchError(this.handleError));
  }
  ...
  canRoleTransferFunds(roleCode: string): Observable<boolean> {
    return this.http
      .get<boolean>(`${this.baseUrl}roles/permissions/can-transfer/${roleCode}`)
      .pipe(catchError(this.handleError));
  }
  ...
  canRoleApproveTransfers(roleCode: string): Observable<boolean> {
    return this.http
      .get<boolean>(`${this.baseUrl}roles/permissions/can-approve/${roleCode}`)
      .pipe(catchError(this.handleError));
  }
  ...
  getFieldsByScreenAndStatus(
    screen: string,
    status: string,
  ): Observable<DynamicFieldsResponseDto[]> {
    return this.http.get<DynamicFieldsResponseDto[]>(
  ...
  getDropdownOptionsByScreenAndType(
    ...
    return this.http.get<any[]>(
      `${this.adminBaseUrl}/dynamic-dropdown-options`,
      { params },
    );
  }
  ...
  findByRecordStatusAndScreenAndDropDown(
    ...
    return this.http.get<any[]>(`${this.adminBaseUrl}dropdown-values/search`, {
      params,
    });
  }
